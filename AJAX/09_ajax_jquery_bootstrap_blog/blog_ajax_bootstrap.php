...
?>
    <div class="container">
        ...
        <div class="col-sm-6 col-sm-offset-3">
            <h1>
                <span class="glyphicon glyphicon-list" style="color: darkgreen"></span>
                &nbsp;Liste des articles
            </h1>
            <hr>
        </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            $("#form").on("submit", function(event){
                ...
                $.post(url, parametres, function(response){
                    $("#enregistrer").html(response.resultat);
            ...
            function liste() {
                $.post("ajax.php", "mode=liste", function(response){
                    console.log(response);
                    $("#liste").html(response.resultat);
                }, 'json');
            }
        });
    </script>
