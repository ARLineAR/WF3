    ...
    <body>
        <div id="conteneur">    
            ...
            <div id="smiley">
                ...
                <img src="smil/smiley3.gif" alt="smiley3">
                <img src="smil/smiley4.gif" alt="smiley4">
                <img src="smil/smiley5.gif" alt="smiley5">
            </div>
        ...
        // Faire en sorte que si l'utilisateur appuie sur ka touche "entrée" cela enregistre le message
        // code touche "entrée" => 13
        document.addEventListener("keypress", function(event){
            
        
            if(event.keyCode == 13){ // si on appuie sur la touche "entrée"
        ...
        // pour récupérer la liste des membres connectés
            ...
            document.getElementById("form").addEventListener("submit", function(e) {
                ...
                // on vide le champ
                document.getElementById("message").value = ""; // ici on récupère ET l'objet ET  la valeur (on ne met pas seulement 'messageValeur = ""' car sinon on ne récupère pas l'objet mais seulement la valeur)
            });
            ...
            function ajax(mode, arg = '') {
                if(typeof(mode) == 'object') {
                    mode = mode.id;
                    //l'argument mode recevra les id des différents éléments de notre page. Sachant que l'on peut sélectionner des éléments html directement par leur id (sans getElelmentBy...) il y a un risque de récupérer  un objet représentant l'élément html. Dans ce cas nous récupérons juste l'id de l'élément (mode = mode.id)
                }
