...
$_SESSION['mdp'] = '1234';  // session st une superglobale donc un array
...
session_destroy();  // suppression de la session MAIS il faut savoir que le session destroy est d'abord vu par l'interpréteur qui ne l'exécute quà la fin du script'
