...
// Connexion à la BDD et traitement du post :
...
if(!empty($_POST)) {
    ...
    $_POST['message'] = htmlspecialchars($_POST['message'], ENT_QUOTES);    // htmlspecialchars convertit les caractères spéciaux (<, >, ', ", &) en entités HTML (par exemple < devient &lt;), ce qui permet de rendre innoffensives les balises HTML. ENT_QUOTES permet d'ajouter les quotes à la liste des caractères convertis.

    // En complément :
    $_POST['message'] = strip_tags($_POST['message']);     // strip_tags permet de supprimer toutes les balises HTML contenu
    ...
    // 2- Nous allons faire une injection SQL : dans les champ message, saisir:  ok'); DELETE FROM commentaire; (
