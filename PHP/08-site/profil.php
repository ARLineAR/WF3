...
// Exercice : 
/*  1- Afficher le suivi des commandes du membre (s'il y en a) dans une liste <ul><li> : id_commande, date et état de la commande. S'il n'y en a pas afficher "Aucune commande en cours" 
    2 -...
*/
